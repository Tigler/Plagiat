...
public interface CSharpParserListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by the {@code foreschStatement}
	 * labeled alternative in {@link CSharpParser#simple_embedded_statement}.
	 * @param ctx the parse tree
	 */
	void enterForeschStatement(CSharpParser.ForeschStatementContext ctx);
	/**
	 * Exit a parse tree produced by the {@code foreschStatement}
	 * labeled alternative in {@link CSharpParser#simple_embedded_statement}.
	 * @param ctx the parse tree
	 */
	void exitForeschStatement(CSharpParser.ForeschStatementContext ctx);
	/**
