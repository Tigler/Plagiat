...
public class CSharpParser extends Parser {
	...
	public static class ForeschStatementContext extends Simple_embedded_statementContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof CSharpParserListener ) ((CSharpParserListener)listener).enterForeschStatement(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof CSharpParserListener ) ((CSharpParserListener)listener).exitForeschStatement(this);
		}
	}
	...
	public final Simple_embedded_statementContext simple_embedded_statement() throws RecognitionException {
		...
		try {
			...
			case 8:
				...
				enterOuterAlt(_localctx, 8);
				{
					listener.onEvent(new EventParser("foreach", EventParser.FOR_START, _localctx.start.getLine(), path));
				setState(1144);
				match(FOREACH);
				setState(1145);
				match(OPEN_PARENS);
				...
				setState(1151);
				embedded_statement();
					listener.onEvent(new EventParser("foreach", EventParser.FOR_END, _localctx.start.getLine(), path));
				}
				break;
			case 9:
				...
				enterOuterAlt(_localctx, 9);
				{
					listener.onEvent(new EventParser("break", EventParser.BREAK, _localctx.start.getLine(), path));
				setState(1153);
				match(BREAK);
				setState(1154);
				match(SEMICOLON);
